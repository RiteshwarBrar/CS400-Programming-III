...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    if (child.equals(parent.leftChild)) {
      if (parent.parent != null) { //checks whether the parent node is a root node
        if (parent.isLeftChild()) {
          parent.parent.leftChild = child;//replaces parent with child
        } else {
      ...
      Node<T> temp = child.rightChild; //stores right child of the child temporarily
  ...
  public void test1() {
    ...
    _instance.insert(2);
    _instance.insert(7);
    _instance.rotate(root.rightChild, root.rightChild.rightChild);// tests rotation inside the tree
    assertEquals(_instance.root.toString(), "[4,3,8,2,5,7]");
  }
  ...
  public void test2() {
    ...
    _instance.insert(2);
    _instance.insert(3);
    _instance.rotate(root.leftChild.rightChild, root.leftChild);// tests rotation inside the tree
    _instance.rotate(root.leftChild, root);// tests rotation at root
    assertEquals(_instance.root.toString(), "[2,1,4,3]");
  }
  ...
  public void test() {
    ...
    _instance.insert(11);
    _instance.insert(13);
    _instance.rotate(root.rightChild, root);

    assertEquals(_instance.root.toString(), "[15,10,12,8,11,13]");
  }
